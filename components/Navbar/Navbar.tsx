  ...
  return (
    <nav className="flex justify-between items-center relative">
      ...
      <div className="lg:hidden flex items-center">
        ...
        <div className={`fixed justify-between flex flex-col p-4 items-center top-0 left-0 h-full w-48 bg-[#1c1c1c] backdrop-blur-3xl bg-opacity-45  border-r border-[#ef9c00] z-40 transform transition-transform duration-300 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
          <div>
            <Logo />
